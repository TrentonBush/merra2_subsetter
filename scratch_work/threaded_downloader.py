...
class DownloadManager(object):
    ...
    def __init__(self, username=os.getenv("MERRA2_USER"), password=os.getenv("MERRA2_PASS"), links=None, download_path="download"):
...
if __name__ == "__main__":
    link = [
        "https://goldsmr4.gesdisc.eosdis.nasa.gov/opendap/MERRA2/M2T1NXSLV.5.12.4/2020/03/MERRA2_400.tavg1_2d_slv_Nx.20200331.nc4.nc4?PS[0:23][232:254][117:139],T10M[0:23][232:254][117:139],U50M[0:23][232:254][117:139],V50M[0:23][232:254][117:139],time,lat[232:254],lon[117:139]"
    ]
